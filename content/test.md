...
<style>
/* Custom styles that work with Congo theme */
.research-interests {
    display: grid;
...
<div class="bibtex-box">
        <button class="copy-button" onclick="copyBibtex('bibtex1')">
            <i class="fas fa-copy"></i> Copy
        </button>
        <pre id="bibtex1">@article{kansoy2025green,
...
<div class="bibtex-box">
        <button class="copy-button" onclick="copyBibtex('bibtex2')">
            <i class="fas fa-copy"></i> Copy
        </button>
        <pre id="bibtex2">@article{kansoy2025central,
...
<div class="bibtex-box">
        <button class="copy-button" onclick="copyBibtex('bibtex3')">
            <i class="fas fa-copy"></i> Copy
        </button>
        <pre id="bibtex3">@article{kansoy2012determinants,
...
<div class="bibtex-box">
        <button class="copy-button" onclick="copyBibtex('bibtex4')">
            <i class="fas fa-copy"></i> Copy
        </button>
        <pre id="bibtex4">@article{kansoy2013islamic,
